    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(text = "Enter the city name to get weather details")
                }
            )
            Spacer(
                modifier = Modifier
...
fun WeatherDetails(data : WeatherModel){
    Column(
        ...
        Row(
            ...
            Text(text = data.location.region, fontSize = 30.sp, color = Color.Gray)
        }
        ...
        Text(
            text = data.current.condition.text.toUpperCase(),
            fontSize = 20.sp,
            textAlign = TextAlign.Center,
            color = Color.Gray,
        )
        ...
        Card {
            Column(
                ...
                Row(
                    ...
                    WeatherKeyVal(key = "Country", value = data.location.country)
                    WeatherKeyVal(key = "Dewpoint", value = "${data.current.dewpoint_c} °C")
                }
